...
First, I will check the correlation of features I expect to have a strong correlation with the target variable ("SalePrice"). Features such as LotArea, Neighborhood, HouseStyle, OverallQual, YearBuilt, KitchenQual, TotRmsAbvGrd, GrLivArea, GarageCars, and YearBuilt.

OverallQual, KitchenQual, and GrLivArea showed a strong positive correlation with SalesPrice. The other features mentioned above had a weak or no correlation to sales price.
...
There are 4 data points I'm concerned with. They are the houses with a GrLiveArea above 4000 sqft. The two with low sales price are outliers as they have an abnormally high amount of square footage with a low sale price. I will be remove these outliers. 
